...
2. Open `global-employee-analytics-dashboard.pbix` **[global-employee-analytics-dashboard.pbix](https://github.com/DRasool7013/-Global-Employee-Analytics-Dashboard/blob/main/Documentation.md)**.in **Power BI Desktop** (free download from Microsoft).
